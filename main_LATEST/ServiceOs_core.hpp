...
#define OS_CORE_FUNCTIONALITIES                                                \
              ...
              FUNC(void, OS_CODE) GetMcalSpinlock                (void);           \
              FUNC(void, OS_CODE) ReleaseMcalSpinlock            (void);           \
              FUNC(void, OS_CODE) TryToGetMcalSpinlock           (void);           \
...
#define OS_CORE_FUNCTIONALITIES_VIRTUAL                                        \
      ...
      virtual FUNC(void, OS_CODE) GetMcalSpinlock                (void) = 0;       \
      virtual FUNC(void, OS_CODE) ReleaseMcalSpinlock            (void) = 0;       \
      virtual FUNC(void, OS_CODE) TryToGetMcalSpinlock           (void) = 0;       \
